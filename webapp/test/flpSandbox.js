		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mind2mdepuswiss-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mind2mdepuswiss-display": {
								"semanticObject": "mind2mdepuswiss",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mind2mdepuswiss",
									"url": sap.ui.require.toUrl("mind2mdepuswiss")
								}
							}
						}
					}
